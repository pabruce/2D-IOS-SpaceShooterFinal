...
class GameOverScene : SKScene {
    ...
    let restartLabel = SKLabelNode(fontNamed:"GillSans")
    let instructionsLabel = SKLabelNode(fontNamed:"GillSans")
    let instructionsLabel2 = SKLabelNode(fontNamed:"GillSans")
